...
;expected: (#object[mm.ch4.rescue_error$eval3775$fn__3776 0x70ac6f9f "mm.ch4.rescue_error$eval3775$fn__3776@70ac6f9f"])
;  actual: (not (#object[mm.ch4.rescue_error$eval3775$fn__3776 0x4118c91a "mm.ch4.rescue_error$eval3775$fn__3776@4118c91a"]))
